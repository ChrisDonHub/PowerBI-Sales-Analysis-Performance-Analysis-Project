...
I leveraged Excel, Power Query, SQL, and finally Power BI (for both DAX and visualization) to transform the data into actionable insights. 

The solution is delivered through a focused two-page Power BI report: 
